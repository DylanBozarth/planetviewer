...
<div className="row">
    ...
    <div className="navRow col-sm-4"><div className={hiddenUI ? "navIcon" : 'hidden'}><NavLink to="/interstellar" className="navButton" onClick={() => props.whoosh.play()}> Interstellar Space</NavLink></div></div>
